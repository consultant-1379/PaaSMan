...
public class SimpleHostRoutingFilter extends ZuulFilter {
    ...
    public static final Log log= LogFactory.getLog(SimpleHostRoutingFilter.class);
    ...
    private HttpResponse forward(HttpClient httpclient, String verb, String uri,
        ...
        switch (verb.toUpperCase()) {
            case "POST":
                ...
                break;
            case "DELETE":
                HttpDelete httpDelete = new HttpDelete(uri + getQueryString());
                httpRequest = httpDelete;
                httpDelete.setEntity(new InputStreamEntity(requestEntity, request
                        .getContentLength()));
                break;
            case "PUT":
